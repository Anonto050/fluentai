...
// User user = new User("john_doe", "john@example.com", "John Doe", "url",
// null);
...
// @Test
// void testCreateUser() {
// UserDTO userDTO = new UserDTO(1, "john_doe", "john@example.com", "John Doe",
// "url", 1);
// User createdUser = new User("john_doe", "john@example.com", "John Doe",
// "url", null);
...
// UserDTO userDTO = new UserDTO(1, "john_doe", "john@example.com", "John Doe",
// "url", 1);
// User updatedUser = new User("john_doe", "john@example.com", "John Doe",
// "url", null);

// when(userService.updateUser(1,
// userDTO)).thenReturn(Optional.of(updatedUser));
