...
import { StoreApiKeysProps } from "@/types/chat";
...
export default function StoreApiKeys({
  ...
  return (
    <>
      <button
        className="z-50 items-center my-2 lg:my-4 text-green-500 hover:text-white hover:bg-green-500 transition-colors"
        onClick={() => {
          setIsModal(!isModal);
        }}
      >
      ...
      <div
        ...
        } absolute min-h-screen min-w-full z-40 transition-all ease-in`}
      >
